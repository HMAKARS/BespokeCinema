  ...
  <table>
    <tr>
      <td class="poster">
        ...
        <div><img src="<%=request.getContextPath()%>/img/imgtest.png">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<img src="<%=request.getContextPath()%>/img/imgdown.png"></div>
        <br>
