...
<head>
  ...
  <script type="text/javascript">
  	...
  	function test(){
  		...
  		var valueByPw = $('#pwd').val();
  		alert(valueById + " " + valueByPw );
  	}
...
<div class="container">
  ...
  <button type="submit" class="btn btn-default" onclick ="location.href='<%=cpath%>/login.do'">로그인</button>
  
  
  
</form>
		<% }else{ %>
			<%=user.getMb_name()%>님 방문을 환영합니다.
    ...
    <button type="button" class="btn btn-success btn-sm" onclick="location.href='<%=cpath%>/reviewList.do'">리뷰 리스트 보기</button>
